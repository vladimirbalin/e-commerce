...
function content_5fb8bf1b290246_78667261 (Smarty_Internal_Template $_smarty_tpl) {
?><div id="centerColumn">
...
/"><?php echo $_smarty_tpl->tpl_vars['product']->value['name'];?>
                ...
                <td>
                    <button id="minusOneItem" onclick="minusOneItem(<?php echo $_smarty_tpl->tpl_vars['product']->value['id'];?>
)">-</button>
...
"
                           ...
                           type="text"
                           value="1"
                           onchange="conversionPrice(<?php echo $_smarty_tpl->tpl_vars['product']->value['id'];?>
);">
                    <button id="plusOneItem" onclick="plusOneItem(<?php echo $_smarty_tpl->tpl_vars['product']->value['id'];?>
)">+</button>
                </td>
                <td>
